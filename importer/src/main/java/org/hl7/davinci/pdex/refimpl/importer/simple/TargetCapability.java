...
class TargetCapability {
  ...
  boolean canPersist(Resource resource) {
    String resourceName = resource.getClass()
        .getSimpleName();
    Optional<CapabilityStatement.CapabilityStatementRestResourceComponent> resourceDescription = getCapabilityResources(
        resourceName);
  ...
  private Optional<CapabilityStatement.CapabilityStatementRestResourceComponent> getCapabilityResources(
      String resourceName) {
  ...
  private boolean hasCreateStatus(CapabilityStatement.CapabilityStatementRestResourceComponent resourceDescription) {
